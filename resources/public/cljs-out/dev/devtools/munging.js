...
var o13397 = temp__5718__auto__;
var temp__5718__auto____$1 = (o13397["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o13398 = temp__5718__auto____$1;
return (o13398["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__12506__auto__ = f;
return (o__12506__auto__["toString"]).call(o__12506__auto__);
} else {
return "";
}
}catch (e13399){var _ = e13399;
return "";
}});
...
try{var o__12506__auto___13401 = t;
(o__12506__auto___13401["cljs$lang$ctorPrWriter"]).call(o__12506__auto___13401,t,writer);
}catch (e13400){var __13402 = e13400;
}
...
var char_code = (function (){var o__12506__auto__ = (new String(char$));
return (o__12506__auto__["charCodeAt"]).call(o__12506__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__12506__auto__ = String;
return (o__12506__auto__["fromCharCode"]).call(o__12506__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__13403 = num_code;
switch (G__13403) {
case (1):
return (185);
...
var o__12506__auto__ = String;
return (o__12506__auto__["fromCharCode"]).call(o__12506__auto__,superscript_code);
});
/**
...
}catch (e13405){var _e__12513__auto__ = e13405;
return false;
}})())){
...
var vec__13406 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__13406,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o13409 = temp__5718__auto__;
var temp__5718__auto____$1 = (o13409["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o13410 = temp__5718__auto____$1;
return (o13410["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__13413){
var vec__13414 = p__13413;
var ns_detector = cljs.core.nth.call(null,vec__13414,(0),null);
...
var G__13420 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__13421 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__13420;
remaining_tokens = G__13421;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq13411){
var G__13412 = cljs.core.first.call(null,seq13411);
var seq13411__$1 = cljs.core.next.call(null,seq13411);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13412,seq13411__$1);
}));
...
var vec__13425 = cljs.core.split_with.call(null,(function (p1__13424_SHARP_){
return cljs.core.not_EQ_.call(null,p1__13424_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__13425,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__13425,(1),null);
...
var vec__13431 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__13431,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__13431,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__13434 = cljs.core.rest.call(null,remaining_tokens);
var G__13435 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__13434;
name_tokens = G__13435;
continue;
} else {
...
var vec__13438 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__13438,(0),null);
var arity = cljs.core.nth.call(null,vec__13438,(1),null);
var vec__13441 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__13441,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__13441,(1),null);
var vec__13444 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__13444,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__13444,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__13444,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__13444,(3),null);
...
var vec__13450 = result;
var munged_ns = cljs.core.nth.call(null,vec__13450,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__13450,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__13450,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__13450,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__13450,(4),null);
var arity = cljs.core.nth.call(null,vec__13450,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__13454 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__13454,(0),null);
var args = cljs.core.nth.call(null,vec__13454,(1),null);
var vec__13457 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__13457,(0),null);
var name = cljs.core.nth.call(null,vec__13457,(1),null);
...
var G__13460 = (arity + (1));
var G__13461 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__13462){
var vec__13463 = p__13462;
var arity = cljs.core.nth.call(null,vec__13463,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__13463,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__13466_SHARP_){
return cljs.core.get.call(null,arities,p1__13466_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__13467_SHARP_){
return cljs.core.drop.call(null,(2),p1__13467_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___13474 = arguments.length;
var i__4737__auto___13475 = (0);
while(true){
if((i__4737__auto___13475 < len__4736__auto___13474)){
args__4742__auto__.push((arguments[i__4737__auto___13475]));

var G__13476 = (i__4737__auto___13475 + (1));
i__4737__auto___13475 = G__13476;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__13470){
var vec__13471 = p__13470;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__13471,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq13468){
var G__13469 = cljs.core.first.call(null,seq13468);
var seq13468__$1 = cljs.core.next.call(null,seq13468);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13469,seq13468__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__13479__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__13479__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__13479__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__13479__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__13480 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__13480,(0),null);
var fn_name = cljs.core.nth.call(null,vec__13480,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__13480,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__13480,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__13480,(4),null);
var arity = cljs.core.nth.call(null,vec__13480,(5),null);
...
var o__12506__auto__ = f;
return (o__12506__auto__["getBasis"]).call(o__12506__auto__);
});
/**
...
}catch (e13484){var _e__12513__auto__ = e13484;
...
var G__13485 = (obj[cljs.core.first.call(null,path)]);
var G__13486 = cljs.core.rest.call(null,path);
obj = G__13485;
path = G__13486;
continue;
} else {
...
var _STAR_ = (function (accum,p__13487){
var vec__13488 = p__13487;
var bit = cljs.core.nth.call(null,vec__13488,(0),null);
var protocol = cljs.core.nth.call(null,vec__13488,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__13491){
var vec__13492 = p__13491;
var ns = cljs.core.nth.call(null,vec__13492,(0),null);
var name = cljs.core.nth.call(null,vec__13492,(1),null);
var selector = cljs.core.nth.call(null,vec__13492,(2),null);
...
var post_process = (function (p__13496){
var vec__13497 = p__13496;
var munged_name = cljs.core.nth.call(null,vec__13497,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__13497,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__13495_SHARP_){
return (obj[cljs.core.first.call(null,p1__13495_SHARP_)]);
}),sorted_matches);
