...
var node = cljs_test_display.core.n.call(null,new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),"cljs-test-display-style"], null),style_string_11628);
...
/** @this {Function} */
(cljs_test_display.core.n.cljs$lang$applyTo = (function (seq11629){
var G__11630 = cljs.core.first.call(null,seq11629);
var seq11629__$1 = cljs.core.next.call(null,seq11629);
var G__11631 = cljs.core.first.call(null,seq11629__$1);
var seq11629__$2 = cljs.core.next.call(null,seq11629__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11630,G__11631,seq11629__$2);
}));
...
var vec__11635 = ((clojure.string.starts_with_QMARK_.call(null,cljs.core.first.call(null,classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,cljs.core.first.call(null,classes),(1)),cljs.core.rest.call(null,classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.call(null,vec__11635,(0),null);
var classes__$1 = cljs.core.nth.call(null,vec__11635,(1),null);
var G__11638 = cljs.core.PersistentArrayMap.EMPTY;
var G__11638__$1 = (cljs.core.truth_(id)?cljs.core.assoc.call(null,G__11638,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__11638);
if(cljs.core.truth_(cljs.core.not_empty.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__11638__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",classes__$1));
} else {
return G__11638__$1;
}
} else {
...
return (function() { 
var G__11642__delegate = function (klass,contents){
var vec__11639 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons.call(null,klass,contents)], null));
var klass__$1 = cljs.core.nth.call(null,vec__11639,(0),null);
var contents__$1 = cljs.core.nth.call(null,vec__11639,(1),null);
...
var G__11642 = function (klass,var_args){
var contents = null;
...
while (G__11643__i < G__11643__a.length) {G__11643__a[G__11643__i] = arguments[G__11643__i + 1]; ++G__11643__i;}
  contents = new cljs.core.IndexedSeq(G__11643__a,0,null);
} 
return G__11642__delegate.call(this,klass,contents);};
G__11642.cljs$lang$maxFixedArity = 1;
G__11642.cljs$lang$applyTo = (function (arglist__11644){
var klass = cljs.core.first(arglist__11644);
var contents = cljs.core.rest(arglist__11644);
return G__11642__delegate(klass,contents);
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__11648){
...
var file = cljs.core.get.call(null,map__11649__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__11651){
...
var actual = cljs.core.get.call(null,map__11652__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.call(null,map__11652__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__11654){
...
var expected = cljs.core.get.call(null,map__11655__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.call(null,map__11655__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__11657_SHARP_){
return cljs.core.cons.call(null,new_current_node,p1__11657_SHARP_);
}));
...
var curr_node = cljs_test_display.core.current_node.call(null);
var map__11659 = cljs_test_display.core.current_var_info.call(null);
...
var info = map__11659__$1;
var name = cljs.core.get.call(null,map__11659__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.call(null,map__11659__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__11659__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__11658_SHARP_){
return cljs.core.cons.call(null,node,p1__11658_SHARP_);
}));

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__11661){
...
var m = map__11662__$1;
var fail = cljs.core.get.call(null,map__11662__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.call(null,map__11662__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.call(null,map__11662__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.call(null,map__11662__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
var temp__5720__auto___11664 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___11664)){
var message_11665 = temp__5720__auto___11664;
cljs.core.println.call(null,message_11665);
} else {
}
...
var temp__5720__auto___11666 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___11666)){
var message_11667 = temp__5720__auto___11666;
cljs.core.println.call(null,message_11667);
} else {
}
