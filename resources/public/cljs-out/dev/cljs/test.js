...
var G__11549 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__11549,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__11549;
}
}));
...
var len__4736__auto___11554 = arguments.length;
var i__4737__auto___11555 = (0);
while(true){
if((i__4737__auto___11555 < len__4736__auto___11554)){
args__4742__auto__.push((arguments[i__4737__auto___11555]));

var G__11556 = (i__4737__auto___11555 + (1));
i__4737__auto___11555 = G__11556;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq11551){
var G__11552 = cljs.core.first.call(null,seq11551);
var seq11551__$1 = cljs.core.next.call(null,seq11551);
var G__11553 = cljs.core.first.call(null,seq11551__$1);
var seq11551__$2 = cljs.core.next.call(null,seq11551__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11552,G__11553,seq11551__$2);
}));
...
var file = cljs.core.get.call(null,map__11558__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__11558__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__11558__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,(function (p1__11557_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__11557_SHARP_));
...
var temp__5720__auto___11560 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___11560)){
var message_11561 = temp__5720__auto___11560;
cljs.core.println.call(null,message_11561);
} else {
}
...
var temp__5720__auto___11562 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___11562)){
var message_11563 = temp__5720__auto___11562;
cljs.core.println.call(null,message_11563);
} else {
}
...
var output_dir__$1 = (function (){var G__11564 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__11564,"/"].join('');
} else {
return G__11564;
}
})();
...
var temp__5718__auto__ = ((typeof exception.stack === 'string')?(function (){var G__11566 = exception.stack;
var G__11566__$1 = (((G__11566 == null))?null:clojure.string.split_lines.call(null,G__11566));
var G__11566__$2 = (((G__11566__$1 == null))?null:cljs.core.get.call(null,G__11566__$1,depth));
if((G__11566__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__11566__$2);
}
})():false);
if(cljs.core.truth_(temp__5718__auto__)){
var stack_element = temp__5718__auto__;
var fname = cljs.test.js_filename.call(null,stack_element);
var vec__11567 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__11567,(0),null);
var column = cljs.core.nth.call(null,vec__11567,(1),null);
var vec__11570 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__11570,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__11570,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__11570,(2),null);
...
var m__$1 = (function (){var G__11573 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__11577 = (function (){var G__11576 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__11576);
} else {
return G__11576;
}
})();
...
return cljs.core.vary_meta.call(null,G__11578,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__11582 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__11582,(0),null);
var types = vec__11582;
...
return cljs.core.map.call(null,(function (p__11585){
var vec__11586 = p__11585;
var ns = cljs.core.nth.call(null,vec__11586,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__11586,(1),null);
return (function (){
...
var G__11589 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__11589__$1 = (((G__11589 instanceof cljs.core.Keyword))?G__11589.fqn:null);
switch (G__11589__$1) {
case "async":
...
var seq__11590 = cljs.core.seq.call(null,vars__$1);
var chunk__11591 = null;
var count__11592 = (0);
var i__11593 = (0);
while(true){
if((i__11593 < count__11592)){
var v = cljs.core._nth.call(null,chunk__11591,i__11593);
var temp__5720__auto___11595 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___11595)){
var t_11596 = temp__5720__auto___11595;
each_fixture_fn.call(null,((function (seq__11590,chunk__11591,count__11592,i__11593,t_11596,temp__5720__auto___11595,v,each_fixture_fn,G__11589,G__11589__$1,env,once_fixtures,each_fixtures,vec__11586,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_11596)));
});})(seq__11590,chunk__11591,count__11592,i__11593,t_11596,temp__5720__auto___11595,v,each_fixture_fn,G__11589,G__11589__$1,env,once_fixtures,each_fixtures,vec__11586,ns,vars__$1))
);
} else {
}


var G__11597 = seq__11590;
var G__11598 = chunk__11591;
var G__11599 = count__11592;
var G__11600 = (i__11593 + (1));
seq__11590 = G__11597;
chunk__11591 = G__11598;
count__11592 = G__11599;
i__11593 = G__11600;
continue;
} else {
var temp__5720__auto__ = cljs.core.seq.call(null,seq__11590);
if(temp__5720__auto__){
var seq__11590__$1 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__11590__$1)){
var c__4556__auto__ = cljs.core.chunk_first.call(null,seq__11590__$1);
var G__11601 = cljs.core.chunk_rest.call(null,seq__11590__$1);
var G__11602 = c__4556__auto__;
var G__11603 = cljs.core.count.call(null,c__4556__auto__);
var G__11604 = (0);
seq__11590 = G__11601;
...
var v = cljs.core.first.call(null,seq__11590__$1);
var temp__5720__auto___11605__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___11605__$1)){
var t_11606 = temp__5720__auto___11605__$1;
each_fixture_fn.call(null,((function (seq__11590,chunk__11591,count__11592,i__11593,t_11606,temp__5720__auto___11605__$1,v,seq__11590__$1,temp__5720__auto__,each_fixture_fn,G__11589,G__11589__$1,env,once_fixtures,each_fixtures,vec__11586,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_11606)));
});})(seq__11590,chunk__11591,count__11592,i__11593,t_11606,temp__5720__auto___11605__$1,v,seq__11590__$1,temp__5720__auto__,each_fixture_fn,G__11589,G__11589__$1,env,once_fixtures,each_fixtures,vec__11586,ns,vars__$1))
);
} else {
}


var G__11607 = cljs.core.next.call(null,seq__11590__$1);
var G__11608 = null;
var G__11609 = (0);
var G__11610 = (0);
seq__11590 = G__11607;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__11589__$1)].join('')));
