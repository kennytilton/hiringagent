...
var G__21578 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__21578;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__21579 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__21579,ch);
...
if(("\\" === ch__$1)){
var ch_21580__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_21580__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_21580__$2);
} else {
}

var G__21581 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__21581;
continue;
}
}
...
var vec__21589 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__21589,(0),null);
var start_column = cljs.core.nth.call(null,vec__21589,(1),null);
...
var G__21592 = cljs.core.conj_BANG_.call(null,a,form);
a = G__21592;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__21593 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__21594 = true;
(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__21594);

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__21593);
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__21595 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__21595,(0),null);
var start_column = cljs.core.nth.call(null,vec__21595,(1),null);
...
var vec__21598 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__21598,(0),null);
var end_column = cljs.core.nth.call(null,vec__21598,(1),null);
...
var vec__21601 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__21601,(0),null);
var start_column = cljs.core.nth.call(null,vec__21601,(1),null);
...
var vec__21604 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__21604,(0),null);
var end_column = cljs.core.nth.call(null,vec__21604,(1),null);
...
var vec__21607 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__21607,(0),null);
var start_column = cljs.core.nth.call(null,vec__21607,(1),null);
...
var vec__21610 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__21610,(0),null);
var end_column = cljs.core.nth.call(null,vec__21610,(1),null);
...
var sb = (function (){var G__21613 = (new goog.string.StringBuffer());
G__21613.append(initch);
...
var G__21615 = (function (){var G__21614 = sb;
G__21614.append(ch);

return G__21614;
})();
var G__21616 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__21615;
ch = G__21616;
continue;
}
...
switch (G__21619) {
case "\\":
var G__21623 = (function (){var G__21620 = sb;
G__21620.append(cljs.tools.reader.escape_char.call(null,sb,reader));
...
break;
default:
var G__21625 = (function (){var G__21621 = sb;
G__21621.append(ch);

return G__21621;
})();
var G__21626 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__21625;
ch = G__21626;
continue;
...
var vec__21627 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__21627,(0),null);
var end_column = cljs.core.nth.call(null,vec__21627,(1),null);
...
var vec__21630 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__21630,(0),null);
var column = cljs.core.nth.call(null,vec__21630,(1),null);
...
var vec__21635 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__21635,(0),null);
var column = cljs.core.nth.call(null,vec__21635,(1),null);
...
var vec__21640 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__21640,(0),null);
var column = cljs.core.nth.call(null,vec__21640,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__21645 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__21645,(0),null);
var start_column = cljs.core.nth.call(null,vec__21645,(1),null);
...
var vec__21648 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__21648,(0),null);
var end_column = cljs.core.nth.call(null,vec__21648,(1),null);
...
var G__21651 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__21651,true,null,opts,pending_forms);
...
var G__21652 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__21652)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__21652)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__21652)){
...
var _STAR_suppress_read_STAR__orig_val__21653 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__21654 = true;
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__21654);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__21653);
}});
...
var G__21655 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__21655,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__21655,rdr,first_line);
...
var G__21659 = matched;
var G__21660 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__21659;
finished = G__21660;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__21661 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__21662 = (function (){var or__4126__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
...
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__21662);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__21661);
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__21663 = cljs.tools.reader.arg_env;
var arg_env_temp_val__21664 = cljs.core.sorted_map.call(null);
(cljs.tools.reader.arg_env = arg_env_temp_val__21664);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__21665 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__21665,"(");
...
var G__21666 = (i + (1));
var G__21667 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4126__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
...
}finally {(cljs.tools.reader.arg_env = arg_env_orig_val__21663);
}});
/**
...
var ch = temp__5718__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__21668 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__21668);
...
var G__21669 = cljs.core.next.call(null,s__$1);
var G__21670 = ret;
s__$1 = G__21669;
r = G__21670;
continue;
...
var G__21671 = cljs.core.next.call(null,s);
var G__21672 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__21671;
key_vals = G__21672;
continue;
} else {
...
var gensym_env_orig_val__21677 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__21678 = cljs.core.PersistentArrayMap.EMPTY;
(cljs.tools.reader.gensym_env = gensym_env_temp_val__21678);
...
}finally {(cljs.tools.reader.gensym_env = gensym_env_orig_val__21677);
}});
...
var temp__5718__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__21679 = token;
var G__21679__$1 = (((G__21679 == null))?null:cljs.core.subs.call(null,G__21679,(1)));
var G__21679__$2 = (((G__21679__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__21679__$1));
var G__21679__$3 = (((G__21679__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__21679__$2));
var G__21679__$4 = (((G__21679__$3 == null))?null:cljs.core.symbol.call(null,G__21679__$3));
if((G__21679__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__21679__$4);
}
})():(function (){var G__21680 = token;
var G__21680__$1 = (((G__21680 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__21680));
if((G__21680__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__21680__$1);
}
})()
));
if(cljs.core.truth_(temp__5718__auto__)){
...
(cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__21691,reader){
...
var eof = cljs.core.get.call(null,map__21692__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
