...
return cljs.core.reduce.call(null,(function (result,p__13573){
...
var vec__13577 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__13577,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__13577,(1),null);
var ab = cljs.core.nth.call(null,vec__13577,(2),null);
...
var clojure$data$EqualityPartition$equality_partition$dyn_13583 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_13583.call(null,x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_13584 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_13584.call(null,a,b);
}
});
...
return (function (){var G__13588 = clojure.data.equality_partition.call(null,a);
var G__13588__$1 = (((G__13588 instanceof cljs.core.Keyword))?G__13588.fqn:null);
switch (G__13588__$1) {
case "atom":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__13588__$1)].join('')));
